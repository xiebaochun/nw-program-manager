$(function() {
    ...
    if (typeof require != "undefined") {
        ...
        if (typeof require != "undefined") {
            ...
            $("#max").click(function() {
                //console.log(screen.width+":"+$(window).width()+"max click=================================="+win.isMaximized);
        ...
        document.addEventListener("keydown", function(et) {
            //press f5 key to reload the page
            if (et.which == 116) {
                nw =null;
                win = null;
                window.location.reload(true);
            }
            //press f12 key to show the dev tools
            if (et.which == 123) {
                win.showDevTools();
            }
            if (et.which == 122) {
                window.open('./index.html','my window','resizable,scrollbars');
                //window.document.write('<html><head><title>Your Report Title</title></head><body height="100%" width="100%">gdfgdfgdf</body></html>');
            }
        }, false);
